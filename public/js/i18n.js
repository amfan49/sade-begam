...
const STRINGS = {
  fa: {
    ...
    newsletter: {
      title: "خبرنامه",
      intro: "هفته‌ای یک‌بار، خبرهای رسمی درباره‌ی ایران — گردآوری‌شده، مستند و رایگان. ابتدا یک ایمیل تأیید می‌فرستیم؛ بدون تأیید شما چیزی ارسال نمی‌شود و هر زمان می‌توانید لغو اشتراک کنید.",
    ...
    impressum: {
      title: "اطلاعات حقوقی و حریم خصوصی",
      operatorTitle: "مسئول سایت",
      operatorName: "Amir Fanaei",
      operatorNote: "این وب‌سایت صرفاً برای اطلاعات شخصی اداره می‌شود و به‌طور خصوصی نگهداری می‌شود؛ به همین دلیل نشانی پستی درج نشده است. برای تماس، از ایمیل زیر یا فرم تماس استفاده کنید.",
      formTitle: "فرم تماس",
      formNameLabel: "نام (اختیاری)",
      ...
      formSuccess: "متشکرم! پیام شما دریافت شد.",
      formError: "متأسفانه ارسال پیام ممکن نشد. لطفاً مستقیماً به hello@sadebegam.com ایمیل بزنید.",
      newsletterTitle: "خبرنامه و داده‌های شخصی",
      newsletterText: "نشانی ایمیل شما تنها برای ارسال خبرنامه‌ی «ساده بگم» و تنها پس از تأیید شما (ایمیل تأیید دومرحله‌ای) استفاده می‌شود. هیچ داده‌ای به اشخاص ثالث فروخته، اجاره داده یا منتقل نمی‌شود. هر زمان می‌توانید لغو اشتراک کنید.",
  ...
  en: {
    ...
    impressum: {
      ...
      operatorName: "Amir Fanaei",
      operatorNote: "This website is run purely for personal information purposes and is privately maintained; in line with that, no postal address is listed. For contact, use the email address or the contact form below.",
      ...
      formError: "Sorry, sending failed. Please email hello@sadebegam.com directly.",
      newsletterTitle: "Newsletter & Personal Data",
      newsletterText: "Your email address is used solely for the Sade Begam newsletter, and only after you confirm it (double opt-in). No data is ever sold, rented, or shared with third parties. You can unsubscribe at any time.",
